#
#  Be sure to run `pod spec lint EthereumKeyStore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Guo" => "email@address.com" }
  # Or just: s.author    = "Guo"
  # s.authors            = { "Guo" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Guo"
